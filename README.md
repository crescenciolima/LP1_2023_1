# LP1_2023_1
Código desenvolvido na disciplina Linguagem de Programação 1 (LP1) semestre 2023.1

Neste repositório você vai encontrar os códigos produzidos durante os encontros síncronos da disciplina LP1 do Instituto Federal de Educação, Ciência e Tecnologia da Bahia (IFBA) campus Vitória da Conquista semestre 2023.1 do curso Bacharelado em Sistemas de Informação (noturno). 
